...
require(dirname(__DIR__) . "/secrets/esobuilddata.secrets.php");
require(dirname(__DIR__) . "/secrets/esochardata.secrets.php");
require(dirname(__DIR__) . "/secrets/esolog.secrets.php");
