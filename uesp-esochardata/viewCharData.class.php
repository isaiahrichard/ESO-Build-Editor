...
require_once(dirname(__DIR__) . "/secrets/esochardata.secrets.php");
require_once(dirname(__DIR__) . "/uesp-esolog/viewAchievements.class.php");
require_once(dirname(__DIR__) . "/uesp-esolog/esoBookCollectionData.php");
require_once(dirname(__DIR__) . "/uesp-esolog/esoCollectibleData.php");
require_once(dirname(__DIR__) . "/uesp-esolog/esoRecipeData.php");
require_once(dirname(__DIR__) . "/uesp-esolog/esoQuestData.php");
