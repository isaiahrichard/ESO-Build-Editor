...
$__uespWorkspaceRoot = dirname(__DIR__);
require_once($__uespWorkspaceRoot . "/secrets/uespservers.secrets.php");
require_once($__uespWorkspaceRoot . "/secrets/wiki.secrets.php");
